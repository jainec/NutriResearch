...
<body>
    ...
    <div>
      <div>
        <p id="pCaminho">Você está em <span> <a class="a-caminho" href="buscaAlimento.php"> Interface de Busca </a></span> > <span> <a class="a-caminho" href="menuBusca.php"> Menu Alimento </a></span> > <span id="pCaminhoAtual">Receita não encontrada</span></p>    
      </div>
    
      <div class="d-flex justify-content-center pt-5 pb-5">
        <h4>Nenhuma receita foi encontrada para este alimento!</h4>
      </div>
      <div class="d-flex justify-content-center pt-5 pb-5">
      ...
      <div class="d-flex flex-column align-items-center">
        <div>
        <a id="btnVoltar" href="menuBusca.php" class="btn btn-dark" role="button">Voltar</a>
        </div>    
      </div>   
    </div>
