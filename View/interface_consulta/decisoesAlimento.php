...
<div class="wrapper">
    ...
    <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div id="tittle" >           
                    <h3><strong>Decisões - <?=$nome_alimento; ?></strong></h3>
                </div>
            </div>
        </nav>
    ...
    <div>
        <div>
           <p id="p-caminho">Você está em <span> <a class="a-caminho" href="buscaAlimento.php"> Interface de Busca </a></span> > <span> <a class="a-caminho" href="menuBusca.php"> Menu Alimento </a></span> > <span id="p-caminho-atual">Decisões</span></p>
                    ...
                    <div class="">
                        <ul class="list-group">
                          ...
                          while ($row = pg_fetch_array($result1)) { ?>
                            <label style="text-align: center;"><strong><?= $row['tx_rotulo_de_busca'] ?></strong></label>
