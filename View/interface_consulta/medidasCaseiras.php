                        ...
                        <div>
                            <?php
                                ...
                                while ($row_count_medidas = pg_fetch_assoc($result_count_medidas)) {
                                    $_SESSION['id_medida'] = $row_count_medidas['id_medida_caseira'];
                                    ?>
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                        ...
                                                        while ($row_nutrientes_medida = pg_fetch_assoc($result_nutrientes)) {
                                                            ?>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php
                                                        ...
                                                        include '../../Controller/controllerPorcentagemMedidaCaseira.php';
                                                        while ($row_medida_composicao = pg_fetch_assoc($result_composicao)) {
                                                            ?>
                                                    <td><?php echo $row_medida_composicao['fl_qtd_nutriente'] * $porcentagem ?></td>
                                                <?php
                                                        }
                                                        ?>
