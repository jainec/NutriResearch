        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div id="tittle">
                        <h3><strong>Selecionar Indivíduo</strong></h3>
                    </div>
                </div>
            </nav>
            ...
            <div class="center-father">
                <div id="board" class="center-child">
                    ...
                    <h5 style="margin-top: 30px;">Por favor, selecione o indivíduo que deseja avaliar:</h5>
                        ...
                        <table id="table-head" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th td="th-icon" scope="col">Avaliar</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                        ...
                        <table class="table table-striped" id="table">
                            <tbody>
                                ...
                                while ($row_list = pg_fetch_assoc($result)) {
                                    ...
                                    echo '<tr><td id="td-nome">' . $row_list['tx_nome'] . '</td><td id="td-icon" align="center"><form action="cadastroAvaliacao.php" method="POST"><button type="submit" class="btn btn-sm btn-meus-individuos" name="individuo-selecionado" value="' . $row_list['id_individuo'] . '"><i class="icon ion-md-list-box"></i></button></form> </td>';
                                }
