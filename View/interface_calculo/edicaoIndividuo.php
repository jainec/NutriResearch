...
$_SESSION['id_individuo-selecionado-edicao'] = $_POST['individuo-selecionado'];
include '../../Model/sqlSelectIndividuoByID.php';
?>
<!DOCTYPE html>
<html>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/edicaoIndividuo.css" />
		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					...
					<div id="tittle">
						<h3><strong>Editar Indivíduo</strong></h3>
					</div>
				</div>
			</nav>


			<p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceCalculo.php">Interface de Cálculo</a></span> > <span id="pCaminhoAtual">Editar Indivíduo</span></p>
			...
			<div class="center-father">
				<div id="board" class="center-child">
					...
					<div id="divForm">
						<form action="../../Model/sqlUpdateIndividuo.php" method="POST" onsubmit="return ValidateDate();">
							<div id="divNomeData">
								<div id="divNome" class="form-group">
									<label for="inputNome">Nome completo:<span style="color: red;">*</span></label>
									<input type="text" class="form-control" id="inputNome" name="inputNome" value="<?php echo $row_individuo['tx_nome'] ?>" required="yes">
								</div>
								<div id="divData" class="form-group">
									<label for="inputData">Data de Nascimento:</label>
									<input type="text" id="inputData" name="inputData" class="form-control phone-mask" placeholder="dd/mm/aaaa" value=<?php echo $row_individuo['dt_nascimento'] ?>>
								</div>
							...
							<div id="divPesoAlturaSexo">
								<div id="divPeso" class="form-group">
									...
									<input type="number" min="0" step="0.01" class="form-control" id="inputPeso" name="inputPeso" value=<?php echo $row_individuo['fl_peso'] ?>>
								</div>
								<div id="divAltura" class="form-group">
									<label for="inputAltura">Altura (m):</label>
									<input type="number" min="0" step="0.01" class="form-control" id="inputAltura" name="inputAltura" value=<?php echo $row_individuo['fl_altura'] ?>>
								</div>
								<div id="divSexo" class="form-group form-check">
									<label class="form-check-label">Sexo:</label>
									<div>
										<?php if ($row_individuo['tx_sexo'] == 'f') { ?>
											<input type="radio" name="radio" value="f" checked="checked">Feminino<br>
											<input type="radio" name="radio" value="m">Masculino<br>
										<?php } else if ($row_individuo['tx_sexo'] == 'm'){ ?>
											<input type="radio" name="radio" value="f">Feminino<br>
											<input type="radio" name="radio" value="m" checked="checked">Masculino<br>
										<?php } else { ?>
											<input type="radio" name="radio" value="f">Feminino<br>
											<input type="radio" name="radio" value="m">Masculino<br>
										<?php } ?>
							...
							<div id="divPesoAlturaSexo">
								<div id="divPeso" class="form-group">
									...
									<input type="number" min="0" step="0.01" class="form-control" id="cincurferenciaCintura" name="cincurferenciaCintura" aria-describedby="cincurferenciaCintura" value=<?php echo $row_individuo['fl_circunferencia_cintura'] ?>>
								</div>
								<div id="divAltura" class="form-group">
									<label for="cidade">Cidade:</label>
									<input type="text" id="cidade" name="cidade" class="form-control" value="<?php echo $row_individuo['cidade'] ?>">
								</div>
								<div id="divSexo" class="form-group">
									<label for="estado">Estado:</label>
									<input type="text" id="estado" name="estado" class="form-control" value="<?php echo $row_individuo['estado'] ?>">
								</div>
							...
							<div id="divEmailCelular">
								<div id="divEmail" class="form-group">
									...
									<input type="email" class="form-control" id="inputEmail" name="inputEmail" aria-describedby="emailHelp" value="<?php echo $row_individuo['tx_email'] ?>">
								</div>
								<div id="divCelular" class="form-group">
									<label for="inputCelular">Celular:</label>
									<input type="text" id="inputCelular" name="inputCelular" class="form-control" value="<?php echo $row_individuo['tx_celular'] ?>">
								</div>
