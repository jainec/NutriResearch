...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/edicaoNutriente.css" />
        ...
        <div id="content">
            ...
            <div class="center-father">
                <div id="board" class="center-child">
                    ...
                    <h5 style="margin-top: 30px;">Todos os Nutrientes</h5>
                    ...
                    <form autocomplete="off" id="form-search" name="" action="avaliacaoSelecionarIndividuo.php" method="POST">
                        ...
                        <div id="container-busca">
                            <div id="div-input-busca">
                                <input name="inputBusca" id="inputBusca" type="text" class="form-control" placeholder="Digite o nome de um nutriente">
                            </div>
                    ...
                    <div id="div-table">
                        <table class="table table-striped" id="table">
                            <tbody>
                                ...
                                while ($row_list = pg_fetch_assoc($result_nutrientes)) {
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-icon" align="center">
                                            <form action="editarNutriente.php" method="POST">
                                                <button type="submit" class="btn btn-sm btn-meus-individuos" value=<?= $row_list['id_nutriente'] ?> name="nutriente-selecionado">
