...
include '../../Model/sqlSelectDecisaoById.php';
?>
<!DOCTYPE html>
<html>
...
<head>
	...
	<title>Editar Decisão</title>
	<link rel="icon" href="icons/nutri_logo3.png">
	<link rel="stylesheet" type="text/css" href="css/editarDecisao.css" />
		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					...
					<div id="tittle">
						<h3><strong>Editar Decisão</strong></h3>
					</div>
				</div>
			</nav>


			<p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceGerenciamento.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Editar Decisão</span></p>
			...
			<div class="center-father">
				<div id="board" class="center-child">
					...
					<div id="divForm">
						<form action="../../Model/sqlUpdateDecisao.php" method="POST">
							<table>
								<tr>
									<td style="display: none;">
										<label for="id_decisao">Id da decisão<span style="color: red;">*</span></label>
										<input type="text" class="form-control" id="id_decisao" name="id_decisao" value=<?= $row_decisao['id_decisao'] ?> required="yes">
									</td>
									<td>
										<label for="rotulo">Rótulo de busca da decisão<span style="color: red;">*</span></label>
										<input type="text" class="form-control" id="rotulo" name="rotulo" value="<?= $row_decisao['tx_rotulo_de_busca'] ?>" required="yes">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<?php
										if ($row_decisao['id_alimento'] != null) {
											?>
											<script type="text/javascript">
												$('#board').css('height', '550px');
											</script>
											<input type="radio" name="options" id="option1" autocomplete="off" checked value=1> Sim
											<input type="radio" name="options" id="option2" autocomplete="off" value=2> Não
											<div id="divAlimento" style="display: block;">
											...
											<?php
												...
												while ($row_list = pg_fetch_assoc($result)) {
													if ($row_list['id_alimento']  == $row_decisao['id_alimento']) {
														?>
													<option selected="selected" value="<?= $row_list['id_alimento'] ?>">
														<?= $row_list['tx_nome'] ?>
													</option>
												<?php } else {
															?>
										...
										<?php
											...
											?>
											<input type="radio" name="options" id="option1" autocomplete="off" value=1> Sim
								...
								<tr>
									<td>
										...
										<div class="form-group">
											<textarea class="form-control" name="decisao" id="decisao" rows="4" required><?= $row_decisao['tx_descricao'] ?></textarea>
										</div>
									</td>
								</tr>
							</table>
