...
<head>
    ...
    <title>Dicionário de Decisões</title>
    <link rel="icon" href="icons/nutri_logo3.png">
    <link rel="stylesheet" type="text/css" href="css/dicionarioDecisoes.css" />
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div id="tittle">
                        <h3><strong>Dicionário de Decisões</strong></h3>
                    </div>
                </div>
            </nav>
            ...
            <div class="center-father">
                <div id="board" class="center-child">
                    ...
                    <h5 style="margin-top: 30px;">Está em dúvida sobre alguma decisão? </h5>
                    ...
                    <form autocomplete="off" id="form-search" name="" action="avaliacaoSelecionarIndividuo.php" method="POST">
                        ...
                        <div id="container-busca">
                            <div id="div-input-busca">
                                <input name="inputBusca" id="inputBusca" type="text" class="form-control" placeholder="Digite uma dúvida">
                            </div>
                    ...
                    <div id="div-table-head">
                        <table id="table-head" class="table table-striped">
                            <thead>
                                <tr>
                                    <th td="th-icon" scope="col">Rótulo</th>
                                    <th td="th-icon" scope="col">O que fazer</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
