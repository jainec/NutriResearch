...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/removerUsuario.css" />
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div id="tittle">
                        <h3><strong>Remover Usuário</strong></h3>
                    </div>
                </div>
            </nav>


            <p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceCalculo.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Remover Usuário</span></p>
                        ...
                        <table id="table-head" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th td="th-icon" scope="col">Deletar</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                                ...
                                while ($row_list = pg_fetch_assoc($result_usuarios)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-icon" align="center">
                                            <form action="../../Model/sqlDeleteUsuarioById.php" method="POST">
                                                <button type="button" class="btn btn-sm btn-meus-individuos" data-toggle="modal" data-target="#deleteModal-<?php echo $row_list['id_usuario']; ?>">
                                                    <i class="icon ion-md-trash"></i>
                                                </button>
                                                <!-- Modal HTML -->
                                                <div id="deleteModal-<?php echo $row_list['id_usuario']; ?>" class="modal fade">
                                                    <div class="modal-dialog modal-confirm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Você realmente deseja deletar o registro do usuário <?= $row_list['tx_nome'] ?>? Esse processo não pode ser desfeito.</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-info" data-dismiss="modal">Cancelar</button>
                                                                <button type="submit" class="btn btn-danger" value="<?= $row_list['id_usuario'] ?>" name="usuario-selecionado">Deletar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
