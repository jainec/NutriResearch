...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/edicaoMedidaCaseiraParaAlimento.css" />
        ...
        <div id="content">
            ...
            <div class="center-father">
                <div id="board" class="center-child">
                    ...
                    <h5 style="margin-top: 30px;">Todos os Alimentos e suas Medidas Caseiras</h5>
                        ...
                        <table id="table-head" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th id="th-medida" scope="col">Medida Caseira</th>
                    ...
                    <div id="div-table">
                        <table class="table table-striped" id="table">
                            <tbody>
                                <?php
                                include '../../Model/sqlSelectMedidasCaseirasParaAlimentos.php';
                                while ($row_list = pg_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-icon" align="center">
                                            <form action="editarMedidaCaseiraParaAlimento.php" method="POST">
                                                <input style="display: none;" name="medida-selecionada" value=<?= $row_list['id_medida_caseira'] ?>>
