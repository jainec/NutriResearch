...
include '../../Model/sqlSelectNutrienteById.php';
?>
<!DOCTYPE html>
<html>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/editarNutriente.css" />
...
<body>
	...
	/*$displayError = 'none';
	if (isset($_SESSION['nutriente-ja-cadastrado-edicao'] )) {
		$displayError = 'block';
		$alerta = "Um nutriente com esse nome já existe no sistema!";
		$_SESSION['nutriente-ja-cadastrado-edicao']  = null;
	}*/
	?>
		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					...
					<div id="tittle">
						<h3><strong>Editar Nutriente</strong></h3>
					</div>
				</div>
			</nav>


			<p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceGerenciamento.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Editar Nutriente</span></p>
			...
			<div class="center-father">
				<div id="board" class="center-child">
					...
					<div id="divForm">
						<form action="../../Model/sqlUpdateNutriente.php" method="POST">
							<div id="divNomeData">
								<div id="divDescricaoFonte" class="form-group" style="display:none;">
									<label for="id_nutriente">Id do Nutriente:<span style="color: red;">*</span></label>
									<input type="text" class="form-control" id="id_nutriente" name="id_nutriente" value=<?= $row_nutriente['id_nutriente'] ?> required="yes">
								</div>
								<div id="divDescricaoFonte" class="form-group">
									<label for="nome_nutriente">Nome do Nutriente:<span style="color: red;">*</span></label>
									<input type="text" class="form-control" id="nome_nutriente" name="nome_nutriente" value="<?= $row_nutriente['tx_nome'] ?>" required="yes">
								</div>
								<div id="divAbreviatura" class="form-group">
									<label for="abreviatura_nutriente">Abreviatura:<span style="color: red;">*</span></label>
									<input type="text" class="form-control" id="abreviatura_nutriente" name="abreviatura_nutriente" value="<?= $row_nutriente['tx_abreviatura'] ?>" required="yes">
								</div>
								<div id="divMedida" class="form-group">
									<label for="medida_nutriente">Medida do Nutriente:<span style="color: red;">*</span></label>
									<input type="text" class="form-control" id="medida_nutriente" name="medida_nutriente" value="<?= $row_nutriente['tx_medida'] ?>" required="yes">
								</div>
							</div>
