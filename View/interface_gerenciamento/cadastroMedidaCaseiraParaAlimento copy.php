...
<head>
	...
	<title>Cadastrar Medida Caseira para Alimento</title>
	<link rel="icon" href="icons/nutri_logo3.png">
	<link rel="stylesheet" type="text/css" href="css/cadastroMedidaCaseiraParaAlimento.css" />
		...
		<div id="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					...
					<div id="tittle">
						<h3><strong>Cadastrar Medida Caseira para Alimento</strong></h3>
					</div>
				</div>
			</nav>


			<p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceGerenciamento.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Cadastrar Medida Caseira para Alimento</span></p>
			...
			<div class="center-father">
				<div id="board" class="center-child">
					...
					<div id="divForm">
						<form action="../../Model/sqlInsertMedidaCaseiraParaAlimento.php" method="POST">
							<table>
								<tr>
									<td>
									...
									<td>
										...
										<select id="inputMedida" class="form-control" name="medidas[]">
											<?php

											include '../../Model/sqlSelectMedidaCaseira.php';
											while ($row_medida = pg_fetch_assoc($result)) {
												?>
												<option value="<?= $row_medida['id_medida'] ?>">
													<?= $row_medida['tx_descricao'] ?>
												</option>
											<?php
											}
											?>
								...
								<tr>
									<td>
										...
										<input type="number" min=0 step=0.01 value=0 class="form-control" id="inputQtd" name="inputQtd" placeholder="" required="yes">
									</td>
									<td>
