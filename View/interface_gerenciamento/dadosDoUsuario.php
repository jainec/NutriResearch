...
-->
    ...
    <link href="css/gsdk-bootstrap-wizard_dadosUsuario.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="css/dadosDoUsuario.css" />
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceCalculo.php">Interface de Gerenciamento</a></span> > <span><a class="a-caminho" href="avaliacaoSelecionarIndividuo.php">Visualizar Usuário</a></span> > <span id="pCaminhoAtual">Cadastrar Avaliação</span></p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div id="divBotoes">
                            <a id="btnVoltar" href="visualizarUsuarios.php" class="btn btn-dark" role="button">Voltar</a>
                        </div>
