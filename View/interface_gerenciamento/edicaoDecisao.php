...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/edicaoDecisao.css" />
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div id="tittle">
                        <h3><strong>Editar Fonte</strong></h3>
                    </div>
                </div>
            </nav>
            ...
            <div class="center-father">
                <div id="board" class="center-child">
                    ...
                    <h5 style="margin-top: 30px;">Todos as Decisões</h5>
                    ...
                    <form autocomplete="off" id="form-search" name="" action="avaliacaoSelecionarIndividuo.php" method="POST">
                        ...
                        <div id="container-busca">
                            <div id="div-input-busca">
                                <input name="inputBusca" id="inputBusca" type="text" class="form-control" placeholder="Digite o nome de uma decisão">
                            </div>
                        ...
                        <table id="table-head" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th td="th-icon" scope="col">Editar</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div id="div-table">
                        <table class="table table-striped" id="table">
                            <tbody>
                                <?php
                                include '../../Model/sqlSelectDecisoes.php';
                                while ($row_list = pg_fetch_assoc($result1)) {
                                    ?>

                                    <tr>
                                        <td id="td-nome">
                                            <?= $row_list['tx_rotulo_de_busca'] ?>
                                        </td>
                                        <td id="td-icon" align="center">
                                            <form action="editarDecisao.php" method="POST">
                                                <button type="submit" class="btn btn-sm btn-meus-individuos" value="<?= $row_list['id_decisao'] ?>" name="decisao-selecionada">
