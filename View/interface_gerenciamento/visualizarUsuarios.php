...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/visualizarUsuarios.css" />
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceCalculo.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Visualizar Usuários</span></p>
                        ...
                        <table id="table-head" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th td="th-icon" scope="col">Visualizar</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                                ...
                                while ($row_list = pg_fetch_assoc($result_usuarios)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-icon" align="center">
                                            <form action="dadosDoUsuario.php" method="POST">
