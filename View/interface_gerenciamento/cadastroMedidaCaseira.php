...
<head>
	...
	<title>Cadastrar Medida Caseira</title>
...
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			$displayError = 'none';
			if (isset($_SESSION['medida-ja-cadastrada'])) {
				$displayError = 'block';
				$alerta = "Essa medida já existe no sistema!";
				$_SESSION['medida-ja-cadastrada'] = null;
			}
			?>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					...
					<div id="tittle">
						<h3><strong>Cadastrar Medida Caseira</strong></h3>
					</div>
				</div>
			</nav>


			<p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceGerenciamento.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Cadastrar Medida Caseira</span></p>
			...
			<div class="center-father">
				<div id="board" class="center-child">
					...
					<div id="divForm">
						<form action="../../Model/sqlInsertMedidaCaseira.php" method="POST">
							<div id="divNomeData">
								<div id="" class="form-group">
									<label for="descricao_medida">Nome da Medida Caseira:<span style="color: red;">*</span></label>
									<input type="text" class="form-control" id="descricao_medida" name="descricao_medida" placeholder="Insira o nome da medida" required="yes">
								</div>
