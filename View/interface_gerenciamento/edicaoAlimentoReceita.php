...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/edicaoAlimentoReceita.css" />
...
<body>
    ...
    if (isset($_SESSION['alimento-receita-cadastrado'])) {
        $displayError = 'block';
        $alerta = "Um alimento com esse nome já existe no sistema!";
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceGerenciamento.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Editar Alimento-Receita</span></p>
            ...
            <div class="center-father">
                <div id="board" class="center-child">
                    ...
                    <h5 style="margin-top: 30px;">Todos os Alimentos do tipo Receita</h5>
                    ...
                    <form autocomplete="off" id="form-search" name="" action="avaliacaoSelecionarIndividuo.php" method="POST">
                        ...
                        <div id="container-busca">
                            <div id="div-input-busca">
                                <input name="inputBusca" id="inputBusca" type="text" class="form-control" placeholder="Digite o nome de um alimento-receita">
                            </div>
                    ...
                    <div id="div-table">
                        <table class="table table-striped" id="table">
                            <tbody>
                                <?php
                                include '../../Model/sqlSelectAlimentosReceita.php';
                                while ($row_list = pg_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-icon" align="center">
                                            <form action="editarAlimentoReceita.php" method="POST">
                                                <button type="submit" class="btn btn-sm btn-meus-individuos" value="<?= $row_list['id_alimento'] ?>" name="alimento-selecionado">
