...
<head>
    ...
    <title>Atribuir Administrador</title>
    <link rel="icon" href="icons/nutri_logo3.png">
    <link rel="stylesheet" type="text/css" href="css/atribuirAdmUsuario.css" />
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div id="tittle">
                        <h3><strong>Atribuir Administrador</strong></h3>
                    </div>
                </div>
            </nav>


            <p id="pCaminho">Você está em <span><a class="a-caminho" href="interfaceCalculo.php">Interface de Gerenciamento</a></span> > <span id="pCaminhoAtual">Atribuir Administrador</span></p>
                        ...
                        <table id="table-head" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th td="th-icon" scope="col">Administrador?</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                                ...
                                while ($row_list = pg_fetch_assoc($result_usuarios)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-icon" align="center">
                                            <form action="../../Model/sqlUpdateGestor.php" method="POST">
                                                <?php
                                                    if ($row_list['bl_gestor'] == 't') {
                                                        ?>
                                                    <button type="submit" class="btn btn-sm btn-meus-individuos" value="<?= $row_list['id_usuario'] ?>" name="usuario-selecionado">
                                                        <i class="icon"></i>Sim
                                                    </button>
                                                    <input value="sim" name="isGestor" style="display: none;">
                                                <?php
                                                    } else {
                                                        ?>
                                                    <button type="submit" class="btn btn-sm btn-nao" value="<?= $row_list['id_usuario'] ?>" name="usuario-selecionado">
                                                        <i class="icon icon-nao"></i>Não
                                                    </button>
                                                    <input value="nao" name="isGestor" style="display: none;">
                                                <?php }
                                                    ?>
