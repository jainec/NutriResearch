...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/edicaoMedidaCaseira.css" />
        ...
        <div id="content">
            ...
            <div class="center-father">
                <div id="board" class="center-child">
                    ...
                    <h5 style="margin-top: 30px;">Todos as Medidas Caseiras</h5>
                    ...
                    <form autocomplete="off" id="form-search" name="" action="avaliacaoSelecionarIndividuo.php" method="POST">
                        ...
                        <div id="container-busca">
                            <div id="div-input-busca">
                                <input name="inputBusca" id="inputBusca" type="text" class="form-control" placeholder="Digite o nome de uma medida caseira">
                            </div>
                                ...
                                while ($row_list = pg_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="td-icon" align="center">
                                            <form action="editarMedidaCaseira.php" method="POST">
                                                <button type="submit" class="btn btn-sm btn-meus-individuos" value="<?= $row_list['id_medida'] ?>" name="medida-selecionada">
