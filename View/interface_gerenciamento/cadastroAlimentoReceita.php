...
-->
	...
	<title>Cadastro Alimento-Receita</title>
									...
									<div id="board-content" class="tab-content">
										...
										<div class="tab-pane" id="ingredientes">
											<table class="table table-striped">
												<tbody id="tab_logic">
													<tr id="addr0">
														<td>
															<label for="inputAlimento0">Alimento:<span style="color: red;">*</span></label>
															<select id="inputAlimento0" class="form-control" name="alimentos[]" onchange="getAlimentoId(0)" required>
														...
														<td>
															...
															<select id="selectMedida0" class="form-control" name="medidas[]" required>
										...
										<div class="tab-pane td-padding-left" id="fonte">
											<div style="width: 500px; text-align: center;">
												...
												<select id="" class="form-control" name="fontes[]" style="width:500px">
													<?php

													include '../../Model/sqlSelectFonte.php';
													while ($row_fonte = pg_fetch_assoc($result)) {
														echo '<option value="' . $row_fonte['id_fonte'] . '"> ' . $row_fonte['tx_descricao'] . ' </option>';
													}
													?>
