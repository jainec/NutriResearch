...
<body>
	...
	<?php
	$displayError = 'none';
	if (isset($_SESSION['alimento-ja-cadastrado'])) {
		$displayError = 'block';
		$alerta = "Esse alimento já existe no sistema!";
		$_SESSION['alimento-ja-cadastrado'] = null;
	}
	?>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					<div id="container-title">
						...
						<div id="sidebarTitle">
							<h3><strong>Cadastrar Alimento</strong></h3>
						</div>
					</div>
								...
								<form action="../../Model/sqlCadastrarAlimento.php" method="POST">
									...
									<div id="board-content" class="tab-content">
											...
											<table>
												<tr>
													<td>
														...
														<input type="text" required class="form-control" id="inputNome" name="inputNome" placeholder="Insira o nome do alimento" style="width: 500px;">
													</td>
												</tr>
												<tr>
													<td>
														<label class="label-nome" for="inputGramas">Gramas:<span style="color: red;">*</span></label>
														<input type="number" min="0" required step="0.01" class="form-control" id="inputGramas" name="inputGramas" placeholder="" style="width:100px;">
													</td>
										...
										<div class="tab-pane" id="composicao">
											<?php
											include '../../Model/sqlSelectNutrientes.php';
											while ($row_nutrientes = pg_fetch_array($result_nutrientes)) {
												?>
												<div class="nutriente_composicao">
													<label for="nutriente-<?= $row_nutrientes['id_nutriente'] ?>"><?= $row_nutrientes['tx_abreviatura'] ?> (<?= $row_nutrientes['tx_medida'] ?>):</label>
													<input type="number" min="0" step="0.01" class="form-control" id="nutriente-<?= $row_nutrientes['id_nutriente'] ?>" name="nutriente-<?= $row_nutrientes['id_nutriente'] ?>" placeholder="" style="width: 100px;">
												</div>
											<?php
											}
											?>
